...
```{r}
#newdataset = dataset[dataset[,1] %in% c("Canada", "United States of America"),]
#newdataset$year = as.numeric(as.character(newdataset$year))
#newdataset = filter(newdataset, newdataset$year <= 1970)
#proportion = sum(newdataset[, 3:4])/sum(dataset[,3:4])
#proportion
```
The proportion of mainland North American males aged 20-29 that lived in 1970 or before is proportion
