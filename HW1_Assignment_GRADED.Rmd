...
Beauty:
\bigbreak
The document is more visually appealing and has decent readability. The coding output and visualizations are averagely attractive.
...
\bigbreak
Please take care to ensure that one's repo includes the image files that are included in one's .rmd file.  Otherwise, they may not appear in the graded work that is pushed to the student's git.
\bigbreak
